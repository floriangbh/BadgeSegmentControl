...
open class Segment: UIView {
    ...
    // Appearance
    open var appearance: SegmentAppearance?

    internal var didSelectSegment: ((_ segment: Segment) -> Void)?
    ...
    // Init
    internal init(appearance: SegmentAppearance?) {
